...
% CONF:DDPDAPPL:STAT OFF % Turn off DPD
% CONF:DDPDAPPL:STAT ON % Turn on DPD

% CONF:DDPD:STAR;*WAI % Start Dir. DPD
% TRAC:IQ:BWID 5e+8 % Set measurement bandwidth of the AMPLIFIER section
% SENS:FREQ:CENT 6800000000 % Set center frequency (AMP Section but seems
